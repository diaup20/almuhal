...
export const defaultSiteData: SiteData = {
  ...
  seo: {
    siteTitle: 'المهل للنقليات وخدمات النقل في مكة | نقل بركسات وحاويات ومعدات ثقيلة',
    metaDescription: 'شركة المهل للنقليات وخدمات النقل الشاملة في مكة المكرمة والمملكة. متخصصون في نقل البركسات، نقل الحاويات، نقل الصبيات الخرسانية، نقل الحديد، نقل المولدات، والمعدات الثقيلة بأعلى معايير الأمان.',
    keywords: [
      'المهل للنقليات',
      'خدمات النقل في مكة',
      'نقليات مكة',
    ...
    ogImage: 'https://almuhal.vercel.app/og-image.jpg',
    canonicalUrl: 'https://almuhal.vercel.app/',
    schemaOrgName: 'المهل للنقليات وخدمات النقل',
    schemaPhone: '+966501234567',
    schemaAddress: 'شارع حسين سرحان - بجانب رافعة ونش كرين مكة، مكة المكرمة، المملكة العربية السعودية'
  }
};
