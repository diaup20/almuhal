...
export const defaultSiteData: SiteData = {
  ...
  seo: {
    siteTitle: 'المهل للنقليات وخدمات النقل | الحل الأمثل للبركسات والحاويات والمعدات',
    metaDescription: 'شركة المهل للنقليات وخدمات النقل الشاملة بالسعودية - متخصصون في نقل البركسات، نقل الحاويات، الصبيات الخرسانية، نقل الحديد، والمولدات بأعلى أمان وسرعة.',
    keywords: [
      'المهل للنقليات',
      'نقليات',
      'خدمات نقل',
      ...
      'نقل صبيات',
      'نقل مكيفات كبيرة',
      'شركة نقل ثقيل الرياض',
      'نقل بضائع السعودية',
      'شاحنات نقل بركسات'
    ],
    ogImage: heavyFleetImg,
    canonicalUrl: 'https://almahl-transport.com',
